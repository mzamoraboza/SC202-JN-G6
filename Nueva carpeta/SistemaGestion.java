<<<<<<< HEAD:Nueva carpeta/SistemaGestion.java
...
public class SistemaGestion {
        ...
        public void agregarCurso(Curso curso) {
                ...
                cursos[cursoCount++] = new Curso("Curso de desarrollo web", "Desarrollo web",
                ...
                cursos[cursoCount++] = new Curso("Curso de diseño gráfico", "Diseño gráfico",
                ...
                cursos[cursoCount++] = new Curso("Curso de ciberseguridad", "Ciberseguridad",
                                "Martes y Jueves 20:00 - 22:00");
        ...
        public void inscribirEstudianteEnCurso(Estudiante estudiante, Curso curso) {
                if (inscripcionCount < inscripciones.length) {
                        Inscripcion inscripcion = new Inscripcion(estudiante.obtenerIdEstudiante(), curso.getIdCurso());
                        inscripciones[inscripcionCount++] = inscripcion;
                        JOptionPane.showMessageDialog(null, "Inscripción exitosa: " + estudiante.obtenerNombre()
                                        + " en " + curso.getnombreCurso());
                } else {
                        JOptionPane.showMessageDialog(null, "No se pueden registrar más inscripciones.", "Error",
                                        JOptionPane.ERROR_MESSAGE);
                }
        }

        // Método para mostrar los cursos inscritos por un estudiante
        public void mostrarCursosInscritos(Estudiante estudiante) {
                StringBuilder cursosInscritos = new StringBuilder(
                                "Cursos inscritos por " + estudiante.obtenerNombre() + ":\n");
                boolean encontrado = false;
                for (int i = 0; i < inscripcionCount; i++) {
                        Inscripcion inscripcion = inscripciones[i];
                        if (inscripcion.getIdEstudiante() == estudiante.obtenerIdEstudiante()) {
                                encontrado = true;
                                for (Curso curso : cursos) {
                                        if (curso.getIdCurso() == inscripcion.getIdCurso()) {
                                                cursosInscritos.append("ID: ").append(curso.getIdCurso())
                                                                .append(", Nombre: ").append(curso.getnombreCurso())
                                                                .append(", Descripción: ")
                                                                .append(curso.getdescripcion())
                                                                .append(", Horario: ").append(curso.gethorario())
                                                                .append("\n");
                                        }
                                }
                ...
                if (encontrado) {
                        JOptionPane.showMessageDialog(null, cursosInscritos.toString(), "Cursos Inscritos",
                                        JOptionPane.INFORMATION_MESSAGE);
                } else {
                        JOptionPane.showMessageDialog(null,
                                        "No hay cursos inscritos para " + estudiante.obtenerNombre(),
                                        "Cursos Inscritos", JOptionPane.INFORMATION_MESSAGE);
                }
        }
        ...
        public void listarInscripciones() {
                ...
                JOptionPane.showMessageDialog(null, lista.toString(), "Lista de Inscripciones",
                                JOptionPane.INFORMATION_MESSAGE);
        }
...
>>>>>>> 801811d81090c5672c8518aa34dcbb3f1a396eca:proyectofinalPOO/src/main/java/sc202jng6/proyectofinalpoo/SistemaGestion.java
